...
avail_files <- list.files(path="/scratch/ttuff/Tree_sampling/Finished_tree_sets", recursive=TRUE, pattern="Full_trees*")

finished_files <- list.files(path="/scratch/ttuff/Tree_sampling/Finished_tree_prunes", recursive=TRUE)
...
files <- paste0("/scratch/ttuff/Tree_sampling/Finished_tree_sets/", pre_files)
...
save(pruned_trees_and_stats, file=paste("/scratch/ttuff/Tree_sampling/Finished_tree_prunes/PercentRemoved_", percent_remove, "_", pre_files, sep=""))
